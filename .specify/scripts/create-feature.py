...
def create_feature(
    ...
    patterns = branch_config.get("patterns", [f"{feature_num}-{{feature-name}}"])
    ...
    if branch_name:
        ...
        pattern = patterns[0] if patterns else f"{feature_num}-{{feature-name}}"
    ...
    # Always uses format: 001-feature-name with intelligent slash handling
