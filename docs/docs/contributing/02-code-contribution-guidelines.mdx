...
SpecifyX uses a hybrid documentation approach combining manually maintained guides with auto-generated API reference documentation:

### File Organization
- **User guides**: `docs/docs/guides/` - manually maintained tutorials and how-to guides
- **Contributing guides**: `docs/docs/contributing/` - manually maintained development guidelines
- **API reference**: `docs/docs/reference/` - auto-generated from source code using `docs/scripts/generate-metadata.py`
...
- Write comprehensive docstrings in your code - they appear in auto-generated API docs
...
- Service documentation should focus on architecture and usage patterns
- Guides should be user-focused and provide step-by-step instructions

The API reference documentation is automatically generated from Python docstrings, type hints, and code structure, ensuring it stays current with code changes without manual maintenance.
