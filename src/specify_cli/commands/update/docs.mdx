...
```bash
$ specifyx updat perform --dry-run
...
- [Installation Guide](/docs/guides/installation) - Initial SpecifyX installation methods
- [Getting Started Guide](/docs/guides/quickstart) - Post-installation setup
- [Update Service API](/docs/reference/api/update_service) - Technical implementation details
- [check Command](/docs/reference/cli/check) - System validation and connectivity testing