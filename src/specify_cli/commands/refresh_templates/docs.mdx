...
### Status Indicators
- `✓ Configured` - File exists and matches template
- `⚠️ Modified` - File exists but differs from template
- `✗ Missing` - Template file doesn't exist in project
- `🔒 Skipped` - File automatically skipped (user modifications detected)
...
- [add-ai Command](/docs/reference/cli/add-ai) - Adding AI assistants
