...
class PyPIVersionChecker:
    ...
    def _get_current_version(self) -> str:
        ...
        try:
            ...
            return version("specifyx")  # TODO: Move package name to constants.py
        except Exception:
            return "0.1.0"  # TODO: Move fallback version to constants.py
    ...
    def _save_cache(self, data: Dict[str, Any]) -> None:
        ...
        try:
            FileOperations.ensure_directory(self.cache_dir)
    ...
    def _fetch_latest_version(
        ...
        try:
            with httpx.Client(timeout=10.0) as client:
                ...
                # HTTP 304 Not Modified - use cached data
            ...
            # Network or parsing errors - return cached version if available
            if cached_data:
                return cached_data.get("latest_version")
    ...
    def check_for_updates(
        ...
        cached_data = self._load_cache() if use_cache else None
        if cached_data and cached_data.get("current_version") == current_version:
            latest_version = cached_data.get("latest_version")
        else:
            latest_version = self._fetch_latest_version(cached_data)
    ...
    def get_latest_version(self, use_cache: bool = True) -> Optional[str]:
        ...
        cached_data = self._load_cache() if use_cache else None
        return self._fetch_latest_version(cached_data)
